...
class DataRepository private constructor(
    ...
    fun getMovies(): LiveData<Resource<PagedList<MoviesEntity>>> {
        return object : NetworkBoundResource<PagedList<MoviesEntity>, List<DataResponse>>(appExecutors) {
    ...
    fun insertFavorite(favoriteEntity: FavoriteEntity) = localDataSource.insertFavorite(favoriteEntity)

    fun deleteFavorite(favoriteEntity: FavoriteEntity) = localDataSource.deleteFavorite(favoriteEntity)
}